...
const Aboutus = () => {
  return (
    <section id="aboutus" className="relative bg-white py-4 md:py-16 px-4 overflow-hidden">
      



      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-stretch relative z-10">
        {/* Left Content */}
